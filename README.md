...
#### 🖥️ 1. Client Layer (Tầng giao diện & Người dùng)
...
#### 🛡️ 2. Entry Points & Security (Tầng bảo mật & Điều hướng)
...
#### ⚙️ 3. Backend Microservices (Tầng dịch vụ lõi)
...
#### 🔐 4. Authorization Strategy (Chiến lược phân quyền)
...
#### ⚡ 5. Kỹ thuật xử lý dữ liệu & Hiệu năng (Performance & Data Handling)
...
* **⚡ Synchronous (Đồng bộ):** Triển khai **gRPC** cho các tác vụ đòi hỏi hiệu năng cao và phản hồi tức thời giữa các Service nội bộ (Ví dụ: Order Service truy vấn tồn kho từ Product Service).
* **📬 Asynchronous (Bất đồng bộ):** Sử dụng **RabbitMQ** để xử lý các sự kiện (Event-driven). Điển hình là `Notification Service` sẽ lắng nghe và tiêu thụ các sự kiện đơn hàng để thực hiện tác vụ gửi thông báo.
